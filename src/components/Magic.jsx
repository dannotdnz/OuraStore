                ...
                <div className="container">
                    <div className="row my-5">
                        <div className="col-sm-5 col-12 mb-5">
                            ...
                            <h5 className="text-white mt-3 mb-1">Kalkulator Magic Wheel</h5>
                        ...
                        <div className="col-sm-7 col-12">
                            <form method="post" target="">
                                <div className="row">
                                    <h5 className="mb-2 text-white">Geser Sesuai Point Magic Wheel Anda</h5>
                                    <div className="col-12 col-lg-8 mb-5">
                                        <div className="slidecontainer">
                                            <p></p>
                                            <span>
                                                <span color="white">Point Magic Wheel Anda :</span>
                                            </span>
                                            <span id="f" style={{ fontWeight: 'bold', color: '#30cdf8' }}>57</span>
                                            <br />
                                            <input id="myRange" className="slider" type="range" min="0" max="199" value="100" name="sld6"></input>
                                            <br/>
                                            <span color="white">Membutuhkan Maksimal :</span>
                                            <span id="slider_value2" style={{ color: 'white', fontWeight: 'bold' }}>7830</span>
